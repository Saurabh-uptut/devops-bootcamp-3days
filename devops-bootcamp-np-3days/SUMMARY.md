...
* [Infrastructure as Code - Terraform](<README (1).md>)
  ...
  * [Lab 3: Store Terraform State Remotely in AWS S3 with DynamoDB State Locking](infrastructure-as-code-terraform/lab-3-terraform-state-file-remote-storage.md)
  ...
  * [Lab 5: Building Reusable Components in Terraform on AWS](infrastructure-as-code-terraform/lab-6-troubleshooting-terraform-scripts-aws-cloud.md)
  * [Lab 6: Provision AWS Infrastructure using Reusable Terraform Modules](infrastructure-as-code-terraform/lab-8-provision-infrastructure-using-reusable-modules-aws.md)
  * [Lab 7: (Optional) Building Custom Module](infrastructure-as-code-terraform/lab-5-building-custom-module.md)
  * [Lab 9: Terraform Workspaces](infrastructure-as-code-terraform/lab-9-terraform-workspaces.md)
  * [Lab 8: Publish Terraform Modules as Git Submodules for Easy Distribution](infrastructure-as-code-terraform/lab-10-publish-terraform-modules-as-git-submodules-for-easy-distribution.md)
  * [Lab 9:  (optional) Troubleshoot AWS Scripts](infrastructure-as-code-terraform/lab-11-troubleshoot-aws-scripts.md)
...
* [Orchestration with Kubernetes](orchestration-with-kubernetes/README.md)
  ...
  * [Lab 0: Provision an AWS Elastic Kubernetes Service Cluster Using Terraform](orchestration-with-kubernetes/lab-7-provision-an-aws-elastic-kubernetes-service-cluster-using-terraform.md)
  ...
  * [Lab 6: Deploy a Standalone Node.js Application on EKS Cluster](orchestration-with-kubernetes/lab-6-deploy-a-standalone-nodejs-application-on-gke-cluster.md)
  ...
  * [Lab 10: Persist Your Data with PV and PVC on EKS](orchestration-with-kubernetes/lab-10-persist-your-data-with-pv-and-pvc-on-gks.md)
...
* [CI/CD Pipelines with Jenkins](ci-cd-with-jenkins/slides.md)
  * [Jenkins Slides](slides/jenkins-slides.md)
...
* [Configuration Management with Ansible](configuration-management-with-ansible/README.md)
  * [Slides](configuration-management-with-ansible/slides.md)
  * [Lab 1 - Installing Ansible](configuration-management-with-ansible/lab-1-installing-ansible.md)
  * [Lab 2 - Ansible Inventory File](configuration-management-with-ansible/lab-2-ansible-inventory-file.md)
  * [Lab 3 - Learning Adhoc Commands](configuration-management-with-ansible/lab-3-learning-adhoc-commands.md)
  * [Lab 4 - Create your first ansible playbook](configuration-management-with-ansible/lab-4-create-your-first-ansible-playbook.md)
  * [Lab 5 - Install Docker on remote server using Ansible](configuration-management-with-ansible/lab-5-install-docker-on-remote-server-using-ansible.md)
  * [Lab 6 - Deploy a three tier application using Ansible](configuration-management-with-ansible/lab-6-deploy-a-three-tier-application-using-ansible.md)
  * [Lab 7 - Ansible Roles](configuration-management-with-ansible/lab-7-ansible-roles.md)
